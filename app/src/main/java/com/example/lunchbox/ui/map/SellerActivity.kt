...
class SellerInfoFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Set up click listener for textButton
        val textButton = view.findViewById<Button>(R.id.textButton)
...
class SellerInfoFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        textButton.setOnClickListener {
            // Navigate to the sentFragment
            findNavController().navigate(R.id.action_map_seller_info_to_sentFragment)
        }
    }
